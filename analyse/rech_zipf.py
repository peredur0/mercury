...
if __name__ == '__main__':
    ...
    print(f"cout min brown (- stopwords) moyenne: {min(zbsmoth_cmoy):.2f}, median: {min(zbsmeth_cmoy):.2f}")
    ...
    print(f"Coefficient min brown (- stopwords) moyenne: {zbsmot_coef_cmin:.2f}, median: {zbsmet_coef_cmin:.2f}")
