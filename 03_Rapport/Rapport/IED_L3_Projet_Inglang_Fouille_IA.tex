...
\section{Phase 2: Traitement des données}
	...
	\subsection{Analyses statistiques}
		...
		\paragraph{Statistiques des mots et caractères} Lorem Ipsum
			\begin{table}[htbp]
				\centering
				\captionof{table}{Statistiques sur les données des mots}
			...
			\end{table}
				...
				\begin{table}[H]
					\centering
					\captionof{table}{Statistiques sur les données des caractères}
					\begin{tabular}{|l|c|c|c|c|c|c|}
						\hline
		...
		\paragraph{Statistiques des ponctuations} Lorem Ipsum
			\begin{table}[htbp]
				\centering
				\captionof{table}{Statistiques sur les ponctuations}
				\resizebox{\columnwidth}{!}{\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|}
					\hline
		...
		\paragraph{Statistiques des espaces et des lignes}
			\begin{table}[htbp]
				\centering
				\captionof{table}{Statistiques sur les espaces et les lignes}
				\resizebox{\columnwidth}{!}{\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|}
					\hline
