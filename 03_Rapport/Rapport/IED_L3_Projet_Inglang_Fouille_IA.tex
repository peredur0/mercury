...
\section{Introduction}
	...
	\subparagraph{La phase 1} concerne la récolte des informations et les traitements minimum nécessaire pour la mise en base. Les objectifs de traitement de cette phase sont:
	\begin{itemize}
	...
	\subparagraph{La phase 2} vise à générer les données statistiques et numériques à partir des corps de mails.
	% todo : description rapide des actions de la phase 2
	
	\subparagraph{La phase 3} regroupe tous les opérations d'exploitation des données et vise à développer et à créer un modèle de classement des mails et à évaluer ses performances.\\
...
def import_from_file(chemin):
    try:
		...
		\subsubsection{Extraction des corps des mails}
			...
			% Todo : exemple de partie de mails qui ne nous intéressent pas ????			
