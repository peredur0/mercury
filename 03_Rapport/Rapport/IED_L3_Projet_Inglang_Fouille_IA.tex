...
advantage of the trusted zone file transfer option.
		...
		\subsubsection{Mise en base}
			...
			\end{figure}
			Le \emph{hash} calculé lors de la phase de traitement est l'identifiant unique du mail dans toute les bases. La catégorie du mail est également présente dans les deux bases. 
